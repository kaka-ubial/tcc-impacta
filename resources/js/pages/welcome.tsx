...
function StatCounter({
    ...
    return (
        <div>
            <span className="block font-display text-5xl leading-none font-bold text-brand md:text-6xl">
                ...
                <section className="mx-auto max-w-6xl px-6 py-20 md:py-28 lg:py-32">
                    <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-[1fr_320px]">
                        <div className="max-w-2xl">
                            ...
                            <h1 className="mt-5 font-display text-[2.75rem] leading-[1.06] font-bold tracking-tight text-foreground md:text-5xl lg:text-[3.375rem]">
                            ...
                            <p className="mt-6 max-w-lg text-base leading-relaxed text-muted-foreground md:text-lg">
                                Rápido, transparente e humano. Sem burocracia,
                        ...
                        <div
                            className="relative hidden h-80 w-80 shrink-0 lg:block"
                            aria-hidden
                        >
                            <div className="absolute inset-0 rounded-full bg-brand-soft" />
                            <div className="absolute top-10 -right-2 h-20 w-20 rounded-full bg-brand/10" />
                            <div className="absolute bottom-12 -left-3 h-14 w-14 rounded-full bg-brand-green/20" />
                            <div className="absolute inset-0 flex flex-col items-center justify-center gap-5 text-center">
                                <div>
                                    <span className="block font-display text-5xl leading-none font-bold text-brand">
                                ...
                                <div className="bg-warm-border h-px w-10" />
                                <div>
                                    <span className="block font-display text-3xl leading-none font-bold text-foreground">
                                        {stats.instituicoes}
                                    </span>
                                    <span className="mt-1 block text-xs text-muted-foreground">
                            ...
                            {steps.map((step, i) => {
                                ...
                                return (
                                    <div key={i} className="relative md:pr-12">
                                        ...
                                        <span
                                            aria-hidden
                                            className="pointer-events-none font-display text-[5.5rem] leading-none font-bold text-brand/[0.07] select-none"
                                        >
                    ...
                    <div className="mx-auto max-w-6xl px-6">
                        <div className="mb-14 max-w-lg">
                            ...
                            <p className="mt-3 text-muted-foreground">
                                Juntos, já fizemos muito. E ainda há muito mais
                                pela frente.
                            </p>
                        </div>
                ...
                {canRegister && !auth.user && (
                    <section className="bg-brand">
                        <div className="mx-auto max-w-6xl px-6 py-24">
                            <p className="text-xs font-semibold tracking-[0.15em] text-primary-foreground/50 uppercase">
                                Pronta para começar?
                            </p>
                            <h2 className="mt-4 max-w-xl font-display text-3xl font-bold text-primary-foreground md:text-4xl lg:text-5xl">
                                Faça a diferença hoje mesmo.
                            </h2>
                            <p className="mt-5 max-w-md text-base leading-relaxed text-primary-foreground/70">
                                Junte-se à rede Impacta e conecte sua
                                generosidade com quem precisa de apoio.
                            </p>
                            <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
                                <Button
                                    asChild
                ...
                <footer className="bg-[oklch(0.17_0.012_41.0)]">
                    <div className="mx-auto max-w-6xl px-6 py-16">
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-[2fr_1fr_1fr]">
                            <div>
                                ...
                                <p className="mt-4 max-w-xs text-sm leading-relaxed text-[oklch(0.65_0.02_41.0)]">
                                    Conectando quem quer ajudar com quem
                                    precisa.
                                </p>
                            ...
                            <div className="grid grid-cols-2 gap-8 lg:contents">
                                <div>
                                    <p className="text-[0.625rem] font-semibold tracking-[0.14em] text-[oklch(0.48_0.012_41.0)] uppercase">
                                        Plataforma
                                    </p>
                        ...
                        <div className="mt-12 flex flex-col items-start justify-between gap-2 border-t border-white/8 pt-8 text-xs text-[oklch(0.43_0.010_41.0)] sm:flex-row sm:items-center">
                            ...
                            <p>
                                Plataforma de doações solidárias. Comprometida
                                com a LGPD.
                            </p>
                        </div>
                    </div>
