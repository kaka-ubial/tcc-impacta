...
const painelItems: PainelItem[] = [
    {
        ...
        description:
            'Avalie as solicitações de doação pendentes e gerencie o histórico de recebimentos.',
        icon: Gift,
    ...
    },
    {
        title: 'Necessidades',
        description:
            'Cadastre e gerencie os itens que sua instituição precisa receber.',
        icon: Package,
    ...
    },
    {
        ...
        description:
            'Configure os dias e horários em que aceita receber ou coletar doações.',
        icon: Calendar,
    ...
    },
    {
        title: 'Agenda',
        description:
            'Visualize as doações agendadas no calendário e sugira novas datas.',
        icon: CalendarClock,
    ...
    },
    {
        ...
        description:
            'Visualize e edite as informações cadastrais da sua instituição.',
        icon: UserCog,
        href: null,
        accent: 'bg-muted',
    ...
    },
    {
        ...
        description:
            'Transfira itens entre instituições parceiras para otimizar a distribuição de doações.',
        icon: ArrowLeftRight,
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-col gap-0">
                {/* ── Welcome banner ──────────────────────────── */}
                <div className="full-bleed border-b border-border bg-card px-6 py-10">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {available.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="flex h-full flex-col rounded-2xl border border-border bg-card p-6 transition-all duration-200 focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 hover:border-brand/30 hover:shadow-md">
                                        <div
                                            className={`flex size-10 items-center justify-center rounded-xl ${item.accent} ${item.accentText} mb-5`}
                                        >
