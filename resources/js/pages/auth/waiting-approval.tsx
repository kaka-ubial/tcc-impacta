            ...
            <div className="w-full max-w-md space-y-6 rounded-2xl border bg-background p-8 text-center shadow-sm">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Sua instituição foi cadastrada com sucesso. Agora
                        estamos analisando seus dados.
                    </p>
                    <p className="text-sm text-muted-foreground">
                        Você será liberado assim que um administrador aprovar
                        sua conta.
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    <Button asChild variant="outline">
                        <Link href="/settings/profile">Visualizar Perfil</Link>
                    </Button>
                </div>
            </div>
        </div>
