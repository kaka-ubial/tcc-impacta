...
export default function InstituicoesIndex({
    ...
    const searchingTimer = useRef<ReturnType<typeof setTimeout> | undefined>(
        undefined,
    );
    ...
    const itemFilterCount =
        (filters.categoria !== null ? 1 : 0) + (filters.raio !== null ? 1 : 0);
