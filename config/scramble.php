...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'API REST/JSON stateless (autenticação via Laravel Sanctum) que conecta '
            .'doadores e instituições beneficentes: doações, agendamentos de coleta, transferências '
            .'entre instituições e avaliações. Roda em paralelo à aplicação Inertia (routes/web.php), '
            .'que segue servindo a UI por sessão/cookie sem nenhuma alteração de comportamento.',
    ],
